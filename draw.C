...
//--------------------------cables-----------------------
	...
	TLine* spool4_cable1 = new TLine(spool_X4 + spool_L, spool_Y4 + spool_H/2, Cx - side_offset, house_Y);
	spool4_cable1->SetLineWidth(4);
	spool4_cable1->SetLineColor(CLS_Cable2_Color);
	spool4_cable1->Draw();

	TLine* spool4_cable2 = new TLine(Cx - side_offset, house_Y,Cx - side_offset, chimney_Y1);
	spool4_cable2->SetLineWidth(4);
	spool4_cable2->SetLineColor(CLS_Cable2_Color);
	spool4_cable2->Draw();

	TLine* spool4_cable3 = new TLine(Cx - side_offset, chimney_Y1,anchor2_point_X,anchor2_point_Y);
	spool4_cable3->SetLineWidth(4);
	spool4_cable3->SetLineColor(CLS_Cable2_Color);
	spool4_cable3->Draw();
	TLine* spool4_cable4 = new TLine(anchor2_point_X,anchor2_point_Y,CLS_S1_X,CLS_S1_Y);
	...
	TLine* spool6_cable1 = new TLine(spool_X6 - spool_L, spool_Y6 + spool_H/2, Cx + side_offset, house_Y);
	spool6_cable1->SetLineWidth(4);
	spool6_cable1->SetLineColor(CLS_Cable2_Color);
	spool6_cable1->Draw();

	TLine* spool6_cable2 = new TLine(Cx + side_offset, house_Y,Cx + side_offset, chimney_Y1);
	spool6_cable2->SetLineWidth(4);
	spool6_cable2->SetLineColor(CLS_Cable2_Color);
	spool6_cable2->Draw();

	TLine* spool6_cable3 = new TLine(Cx + side_offset, chimney_Y1,anchor1_point_X,anchor1_point_Y);
	spool6_cable3->SetLineWidth(4);
	spool6_cable3->SetLineColor(CLS_Cable2_Color);
	spool6_cable3->Draw();
	TLine* spool6_cable4 = new TLine(anchor1_point_X,anchor1_point_Y,CLS_S2_X,CLS_S2_Y);
...
//------------------------Tags-------------------------
	...
	TLatex *House = new TLatex(Cx - house_W/2*0.95, house_Y + house_H*0.7,"Calibration house");
	...
	TLatex *Side_Cable_tag = new TLatex(Cx + 25*cm, house_Y+8*cm,"Side cable");
	...
	TLatex *ROV = new TLatex(ROV_X + ROV_W + tag2ROV,ROV_Y + 0.5*ROV_H/2,"ROV");
	ROV->SetTextSize(0.035);
	ROV->Draw();
	...
	TLatex *GT = new TLatex(GT_S_X - 80*cm, GT_S_Y - 20*cm,"Guide Tube");
	...
	TLatex *CLS = new TLatex(Cx + R1*1.3*sin(70./180*pi)+5*cm,Cy + R1*1.3*cos(70./180*pi)-5*cm,"CLS");
